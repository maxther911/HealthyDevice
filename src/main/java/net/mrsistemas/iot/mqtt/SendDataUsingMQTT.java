...
public class SendDataUsingMQTT {
	...
	String clientId = "maxther911";
	String channel = "channels/530943/publish/SE6WGQPV7EOELOUN";
	int qos = 0;
		...
		try {
			...
			client.setCallback(new MqttCallback() {
				...
				public void messageArrived(String arg0, MqttMessage arg1) throws Exception {
					...
					System.out.println("Time:\t" + time + "  Topic:\t" + arg0 + "  Message:\t"
							+ new String(arg1.getPayload()) + "  QoS:\t" + arg1.getQos());
				}
